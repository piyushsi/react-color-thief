    ...
    return (
      <div className='root'>
        <div className='head'>
          ...
          <div className='desc'>by-Piyush Sinha<br/>Grab the color palette from an image using just Javascript.
Works in the browser and in React.</div>
          <a className='btn' href='https://github.com/piyushsi/react-color-thief'>View on GitHub</a>
        </div>
        {
          ...
          <div className='itemRoot'>
            ...
            >You can also drag images here</div>
          </div>
        }
      </div>
    )
